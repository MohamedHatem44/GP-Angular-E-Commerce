...
export class AdminBrandFormComponent implements OnInit {
  ...
  private createBrand(brand: Brand) {
    ...
    this._BrandService.createBrand(brand).subscribe({
      ...
      error: (error: any) => {
        this._ToastrService.error('An error occurred while creating the Brand, Please try again.');
        this.apiError = 'An error occurred while creating the Brand, Please try again.';
        this.isLoading = false;
      },
    });
  }
  ...
  private updateBrand(brandId: number, brand: Brand) {
    ...
    this._BrandService.updateBrand(brandId, brand).subscribe({
      ...
      error: (error) => {
        this._ToastrService.error('An error occurred while updating the Brand, Please try again.');
        this.apiError = 'An error occurred while updating the Brand, Please try again.';
        this.isLoading = false;
      },
    });
  }
